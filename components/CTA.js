...
export default function CTA() {
  return (
    <section className='bottom-0 left-0 right-0 px-4 py-10 bg-fiveth'>
      <div className='container mx-auto text-center'>
        ...
        <span className='font-bold md:text-lg xl:text-2xl'>Message me today at <Link href='mailto:nama-email@domain.com' className='underline text-primary'>nama-email@domain.com</Link></span>
      </div >
    </section >
  )
}
