  ...
  return (
    <header className='flex items-center justify-center h-screen bg-fixed bg-center bg-cover hero-background'>
      ...
      <div className='z-[2] items-center justify-center p-5 text-center text-white'>
        <p className='pb-5 text-xl font-bold uppercase text-primary'>{hai}</p>
        <h1 className='mb-5 font-bold uppercase text-8xl'>{heading}</h1>
        <h3 className='mb-5 text-5xl font-bold uppercase text-third'>{message}</h3>
