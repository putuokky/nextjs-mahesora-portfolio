  ...
  return (
    <section className='py-10 bg-sixth px-11'>
      <div className='container mx-auto text-center'>
        ...
        <p className='mb-6 text-white px-14 md:text-xl md:mb-9'>Molestie platea placerat mattis non etiam in dictum. Interdum mattis pellentesque commodo id etiam sociosqu ultrices habitant odio felis fusce. Proin consectetur luctus morbi feugiat sociosqu praesent.</p>
